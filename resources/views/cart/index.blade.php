...
@section('content')
  ...
  <div class="pb-5">
    <div class="container">
            ...
            <table class="table">
              ...
              <tbody>
               ...
               <tr>
                  ...
                  <a href="{{url('/cart/{id}')}}" class="text-dark"><i class="fa fa-trash"></i></a>
                  </td>
                </tr>
      ...
      <!-- </div> -->
      <div class="bg-light rounded-pill px-4 py-3 text-uppercase font-weight-bold">Details de les commands  </div>
          <div class="p-4">
            <p class="font-italic mb-4">Shipping and additional costs are calculated based on values you have entered.</p>
            <ul class="list-unstyled mb-4">
              <li class="d-flex justify-content-between py-3 border-bottom"><strong class="text-muted">Sous_total </strong><strong>{{ getPrice(Cart::subtotal()) }}</strong></li>
...
<div class="col-md-12">votre panier est vide</div>
